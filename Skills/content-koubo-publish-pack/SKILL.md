...
description: Content 口播 Slim 的配套文案生成 Skill。用于同一 Run 的口播正文已获真人确认后，只根据该正文生成或按真人意见修改 2 个封面标题、3 个发布标题、推荐项、50—100 字发布正文和 5 个标签。不得修改正文、搜索 Vault、调用旧标题/分发 Skill 或 Reviewer、保存、发布或进入 P6。
---
