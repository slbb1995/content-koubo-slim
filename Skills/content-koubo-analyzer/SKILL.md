...
description: Content 口播 Slim 的内部爆款拆解与方向 Skill。用于 content-koubo-slim 已在同一 Run 冻结用户原始选题、1—5 篇参考、client_id 和 speaker_mode，并提供当前 Manifest 授权的少量 04 候选后，逐篇拆解、融合冲突、选择真正相关的方法资产，生成完整 Gate A 方向与唯一 Writer 模式建议。不得创建 Run、读取 03/05、写正文或进入 P3。
---
